...
function getCronStringFromValues(period, months, monthDays, weekDays, hours, minutes, humanizeValue, useCronIntervals) {
  if (period === 'reboot') {
    return '@reboot';
  }
  ...
  var parsedArray = parseCronArray([newMinutes, newHours, newMonthDays, newMonths, newWeekDays], humanizeValue, useCronIntervals);
  return cronToString(parsedArray);
}
function partToString(cronPart, unit, humanize, useCronIntervals, leadingZero, clockFormat) {
  var retval = '';
