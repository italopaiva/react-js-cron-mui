...
function PeriodsToDisplay() {
  ...
  return _react["default"].createElement("div", null, _react["default"].createElement("div", {
  ...
  }, _react["default"].createElement("p", null, "You can select only specific periods to be displayed in the dropdown to restrict the options.")), _react["default"].createElement("div", null, _react["default"].createElement(_material.FormControl, {
    style: {
      minWidth: 250,
      maxWidth: 500
    }
  ...
  }, "Periods to Display"), _react["default"].createElement(_material.Select, {
    ...
    input: _react["default"].createElement(_material.Input, null),
    ...
    return _react["default"].createElement(_material.MenuItem, {
      key: period,
      value: period
    }, _react["default"].createElement(_material.Checkbox, {
...
function AllowMultipleSelectFor() {
  ...
  }, _react["default"].createElement("p", null, "You can define specific fields in the component to accept multiple values.")), _react["default"].createElement("div", null, _react["default"].createElement(_material.FormControl, {
    style: {
      minWidth: 250,
      maxWidth: 500
    }
  ...
  }, "Allow multiple select for"), _react["default"].createElement(_material.Select, {
...
function UseCronIntervals() {
  ...
  var _useState81 = (0, _react.useState)('use-cron-intervals-example'),
    _useState82 = _slicedToArray(_useState81, 2),
    key = _useState82[0],
    setKey = _useState82[1];
  function resetCronComponent() {
    setKey(Math.random().toString(36).substring(7));
  }
  return _react["default"].createElement("div", null, _react["default"].createElement("div", {
...
function EmptyNeverAllowed() {
  var inputRef = (0, _react.useRef)();
  var defaultValue = '';
  var _useState117 = (0, _react.useState)(defaultValue),
    _useState118 = _slicedToArray(_useState117, 2),
    value = _useState118[0],
...
function EmptyAlwaysAllowed() {
  var inputRef = (0, _react.useRef)();
  var defaultValue = '';
  var _useState121 = (0, _react.useState)(defaultValue),
    _useState122 = _slicedToArray(_useState121, 2),
    value = _useState122[0],
...
function Shortcuts() {
  ...
  var _useState127 = (0, _react.useState)(),
    ...
    error = _useState128[0],
    onError = _useState128[1];
  var columns = [{
    dataIndex: 'name',
    key: 'name'
  }, {
...
function TwelveHourClock() {
  ...
  var _useState129 = (0, _react.useState)(defaultValue),
    _useState130 = _slicedToArray(_useState129, 2),
    value = _useState130[0],
    setValue = _useState130[1];
  var customSetValue = (0, _react.useCallback)(function (newValue) {
    setValue(newValue);
    inputRef.current = newValue;
  }, [inputRef]);
...
function TwentyFourHourClock() {
  var inputRef = (0, _react.useRef)();
  var defaultValue = '2 5,7,18 * * SUN';
  var _useState133 = (0, _react.useState)(defaultValue),
    _useState134 = _slicedToArray(_useState133, 2),
    value = _useState134[0],
    setValue = _useState134[1];
  var customSetValue = (0, _react.useCallback)(function (newValue) {
    setValue(newValue);
    inputRef.current = newValue;
  }, [inputRef]);
...
function FrenchLocale() {
  ...
  var _useState137 = (0, _react.useState)(defaultValue),
    _useState138 = _slicedToArray(_useState137, 2),
    value = _useState138[0],
    setValue = _useState138[1];
  var customSetValue = (0, _react.useCallback)(function (newValue) {
    setValue(newValue);
    inputRef.current = newValue;
  }, [inputRef]);
  var _useState139 = (0, _react.useState)(),
    _useState140 = _slicedToArray(_useState139, 2),
    error = _useState140[0],
    onError = _useState140[1];
...
function CustomStyle() {
  var inputRef = (0, _react.useRef)();
  var defaultValue = '30 14 22 * *';
  var _useState145 = (0, _react.useState)(defaultValue),
  ...
  var _useState147 = (0, _react.useState)(),
    _useState148 = _slicedToArray(_useState147, 2),
    error = _useState148[0],
    onError = _useState148[1];
